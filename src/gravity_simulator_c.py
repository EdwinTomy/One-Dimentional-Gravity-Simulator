...
class Particle():
    def __init__(self, mass, vel, x_pos, collided = False):
        self.mass = mass
        self.vel = vel
        self.x_pos = x_pos
...
for i in range(time_ellastic):
    ...
    if a.collided and (collision == time_ellastic):
        collision = i
    #print('---------',i)
...
df_collision_if.to_csv('/Users/edwintomy/One Dimensional Gravity Simulator/data/collision_if_training.csv')
...
df_collision_if_test.to_csv('/Users/edwintomy/One Dimensional Gravity Simulator/data/collision_if_testing.csv')
